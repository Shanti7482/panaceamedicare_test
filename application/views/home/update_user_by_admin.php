                ...
                <div class="col-md-12">
                    <div class="container right-container">
                        <div class="heading-box">
                            <div class="add-class">
                                <?php if($status){ ?>
                                <div><a href="<?=base_url('homecontroller/add_user')?>" rel="noopener noreferrer"
                                        class="btn btn-secondary"><i class="fa-duotone fa-solid fa-user-plus"></i></a>
                                </div>
                                <?php }?>
                            </div>
                            <div class="heading">
                        ...
                        <div class="table-container">
                            <form>
                                <div class="mb-5">
                                    ...
                                    <input type="email" class="form-control custom-input-height" id="exampleInputEmail1"
